...
title_figure = 'Camera Calibration Toolbox with automatic feature extraction - Standard Version';
...
cell_list{1,3} = {'Extract grid corners','auto_calib;'};
...
cell_list{3,4} = {'Exit',['disp(''Bye. To run again, type calib_gui_auto.''); close(' num2str(fig_number) ');']}; %{'Exit','calib_gui;'};
